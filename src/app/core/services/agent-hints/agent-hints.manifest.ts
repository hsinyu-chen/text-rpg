...
import { VIRTUAL_HINTS, VIRTUAL_PATHS } from './agent-hints.manifest.base';
 ...
 *  - `VIRTUAL_HINTS` (standalone subtrees with no DOM root — e.g.
 *    `chat-message/*` actions registered programmatically)
 *  - `VIRTUAL_PATHS` (flat leaves under generated containers — per-instance
 *    buttons that can't be statically tagged because `@for` renders N copies)
 *
