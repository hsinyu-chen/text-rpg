...
import { opsToFileUpdates } from '../utils/file-update-ops.util';
 ...
 * `## Act.N - Title` block for this ACT as one string; we emit a single
 * append hunk for it.
 *
...
export function writeStoryOutlineBlock(
    ...
    return opsToFileUpdates(ctx.targetFile, `# ${heading}`, [
