...
- **inventory_log**:
  ...
  - Protagonist-owned only. NPC private items go to `character_log`'s `Possession Change:`. Even when sheltered/lodging/kept, host belongings are NOT protagonist-owned.
