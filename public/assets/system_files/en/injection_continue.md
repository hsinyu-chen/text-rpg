...
- Advance the world timeline: NPCs act, environment changes, events unfold. **You must estimate a reasonable time elapse (precise to the minute, HH:MM) and update the header clock time** based on the specific "wait/observe" context (brief wait 5–15 min; long wait 30+ min; for unconscious/sleep states, advance until awakening).
