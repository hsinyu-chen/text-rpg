...
> 3. All output fields must reflect the corrected final state. The reason/rule of the correction lives only in the `correction` field — no calibration markers in other fields.
