...
- **Key Turning Points**: ONLY add an entry here if the character's core values, behavior, or fate undergoes a **fundamental qualitative change**. When adding one, **also evaluate** whether `### Core Values and Behavior Guidelines` needs to be updated to reflect the change.
